...
class TestArtist(TestCase):
    ...
    def test_collaborators_list(self):
      self.assertIsNone(self.artist_0.collaborators)
      self.assertEqual([], self.artist_1.collaborators)

    def test_eq(self):
      self.assertEqual(self.artist_0, self.artist_0)
      self.assertEqual(self.artist_0, self.artist_1)
      self.assertNotEqual(self.artist_1, self.artist_2)
